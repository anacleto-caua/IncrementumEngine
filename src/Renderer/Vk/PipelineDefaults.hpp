...
namespace PipelineDefaults {
    ...
    inline constexpr VkPipelineInputAssemblyStateCreateInfo DefaultPipelineInputAssemblyStateCreateInfo = {
    ...
    inline constexpr VkPipelineRasterizationStateCreateInfo DefaultPipelineRasterizationStateCreateInfo = {
    ...
    inline constexpr VkPipelineMultisampleStateCreateInfo DefaultPipelineMultisampleStateCreateInfo = {
    ...
    inline constexpr VkPipelineDepthStencilStateCreateInfo DefaultPipelineDepthStencilStateCreateInfo = {
    ...
    inline constexpr VkPipelineColorBlendStateCreateInfo DefaultPipelineColorBlendStateCreateInfo = {
